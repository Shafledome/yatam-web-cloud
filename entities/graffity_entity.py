...
class Graffiti:
    ...
    def get_by_key(key):
        ...
        return Graffiti(key=graffiti['key'], description=graffiti['description'], n_likes=graffiti['nlikes'], url=graffiti['url'], user=graffiti['user'])
    ...
    def update_graffiti(key, data):
        ...
        if isinstance(data, dict):
            ...
            return Graffiti(key=key, description=data['description'], n_likes=data['nlikes'], url=data['url'], user=data['user'])
        else:
            return None
